...
public class PayoutDataInit {
    ...
    public void completePayoutsMore() {
        RsData<Integer> integerRsData1 = payoutFacade.completePayoutsMore(4);
        RsData<Integer> integerRsData2 = payoutFacade.completePayoutsMore(2);
        RsData<Integer> integerRsData3 = payoutFacade.completePayoutsMore(2);
    }
}